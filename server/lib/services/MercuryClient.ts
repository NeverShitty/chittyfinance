...
export class MercuryClient extends BaseServiceClient {
  ...
  constructor(config: ServiceConfig) {
    ...
    // Initialize Cloudflare static IP addresses for high availability routing
    this.cloudflareIPs = process.env.CLOUDFLARE_STATIC_IPS?.split(' ') || [
      '104.16.0.1', '104.17.0.1', '172.64.0.1', '108.162.192.1', '141.101.64.1'
    ];
  }
